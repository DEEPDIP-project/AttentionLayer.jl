...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/DEEPDIP-project/AttentionLayer.jl
   ```
...
- Go back to main screen and click on the latest commit (link: <https://github.com/DEEPDIP-project/AttentionLayer.jl/commit/main>)
...
- After the merge happens, TagBot will trigger and create a new GitHub tag. Check on <https://github.com/DEEPDIP-project/AttentionLayer.jl/releases>
- After the release is create, a "docs" GitHub action will start for the tag.
- After it passes, a deploy action will run.
- After that runs, the [stable docs](https://DEEPDIP-project.github.io/AttentionLayer.jl/stable) should be updated. Check them and look for the version number.
